   ...
   <!-- Header -->
    ...
    <!-- Hero Section -->
            ...
            <div class="hero-content">
                ...
                <a href="../php/Limited-Time-Offers.php" class="hero-btn">Shop Now</a>
            </div>
        </section>
    ...
    <section class="new-arrivals">
        ...
        <div class="view-all">
            <a href="../php/New-Arrival-Section.php">View All</a>
        </div>
    </section>
    ...
    <section class="best-sellers">
        ...
        <div class="view-all">
            <a href="../php/Limited-Time-Offers.php">View All</a>
        </div>
    </section>
