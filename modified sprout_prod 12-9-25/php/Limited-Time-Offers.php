...
// Fetch limited time offers with pagination - SORTED BY discount_percent DESC (highest discount first)
$page = isset($_GET['page']) ? intval($_GET['page']) : 1;
$perPage = 9;
$offset = ($page - 1) * $perPage;

$countQuery = "SELECT COUNT(*) as total FROM products WHERE is_discounted = 1 AND discount_percent > 0";
$countResult = $conn->query($countQuery);
$totalProducts = $countResult->fetch_assoc()['total'];
$totalPages = ceil($totalProducts / $perPage);

// Query to get discounted products sorted by discount_percent DESC
$specialOffersQuery = "SELECT *, (price * (1 - discount_percent/100)) as final_price 
                       FROM products 
                       WHERE is_discounted = 1 AND discount_percent > 0 
                       ORDER BY discount_percent DESC, final_price ASC 
                ...
                <?php while($product = $specialOffersResult->fetch_assoc()): ?>
                    ...
                    <div class="product-card">
                        <div class="product-image">
                            ...
                            <!-- Sale Timer (Static for demo) -->
                            <div class="sale-timer">Sale Ends Soon</div>
                        </div>
                        <div class="product-info">
                            ...
                            <!-- Product Price with Savings Info -->
