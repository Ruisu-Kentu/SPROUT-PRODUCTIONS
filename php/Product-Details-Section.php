...
<head>
    ...
    <title>One Lift Graphic T-shirt</title>
    ...
    <div class="product-container">
        ...
        <div class="thumbnails">
            <div class="thumbnail active">
                <div class="image-placeholder">
                     <img src="../images/product-details/OneLifeGraphicSmall.png" alt="">
                </div>
            </div>
            <div class="thumbnail">
                <div class="image-placeholder">
                        <img src="../images/product-details/OneLifeGraphicBack.png" alt="">
                </div>
            </div>
             <div class="thumbnail">
                <div class="image-placeholder">
        ...
        <div class="main-image">
            ...
            <div class="image-placeholder-large">
                <img src="../images/product-details/OneLifeGraphic.png" alt="">
            </div>
        </div>

        <!-- Right: Product Info -->
        <div class="product-info">
            <h1>One Lift Graphic T-shirt</h1>
    ...
    <div class="details-container">
        ...
        <div class="details-left">
            ...
            <section class="info-section">
                ...
                <p><strong>Name:</strong> One Life Graphic T-shirt</p>
                ...
                <p><strong>Neckline:</strong> Ribbed, round, breathable, non-stretch</p>
        ...
        <div class="product-grid">
            ...
            <div class="product-card">
                <div class="product-image-placeholder">
                    <img src="../images/product-details/PolowithContrast.png" alt="">
                </div>
                ...
                <div class="card-price">
                    <span class="current">₱212</span>
                    <span class="original">₱242</span>
